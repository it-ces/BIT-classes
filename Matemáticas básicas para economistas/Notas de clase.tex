...
\draw (2.46,6.46) node[anchor=north west] {$\sqrt{(x_{i+1} - x_{i})^{2} + (y_{i+1} -y_{i})^{2}$};
\begin{scriptsize}
\draw[color=black] (2.34,9.23) node {$f$};
\draw[color=black] (7.12,9.23) node {$g$};
\draw[color=black] (-5.66,6.61) node {$h$};
\draw[color=black] (-5.66,2.07) node {$i$};
\draw [fill=qqqqff] (2.14,1.74) circle (2.5pt);
\draw[color=qqqqff] (2.28,2.11) node {$A$};
\draw [fill=qqqqff] (7.4,6.76) circle (2.5pt);
\draw[color=qqqqff] (7.54,7.13) node {$B$};
\end{scriptsize}
\end{tikzpicture}
