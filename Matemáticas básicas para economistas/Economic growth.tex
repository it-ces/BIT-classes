...
Es esencial que se conozca este concepto de distancia (note que no es el único), puesto que muchas de las fórmulas "institucionalizadas" en el desarrollo matemático dependen de ella, como por ejemplo el de la circunferencia. nos será útil para trabajar un concepto económico conocido como la frontera de posibilidades de producción.
